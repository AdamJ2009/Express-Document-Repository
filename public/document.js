...
function loadDocumentDetails() {
    return __awaiter(this, void 0, void 0, function () {
        var loadingDiv, detailsDiv, errorDiv, pathSegments, docId, response, doc, downloadLink, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    loadingDiv = document.getElementById('loading');
                    detailsDiv = document.getElementById('documentDetails');
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetch("/api/documents/".concat(docId))];
                case 2:
                    response = _a.sent();
                    if (!response.ok) {
                ...
                case 3:
                    ...
                    if (downloadLink) {
                        downloadLink.href = "/document/".concat(doc.id, "/file");
                    }
                    if (loadingDiv)
                        loadingDiv.style.display = 'none';
                    if (detailsDiv)
