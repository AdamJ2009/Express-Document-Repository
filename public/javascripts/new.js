...
if (uploadForm) {
    uploadForm.addEventListener('submit', async (e) => {
        ...
        const importanceInput = document.getElementById('importanceFlag');
        const archiveSelect = document.getElementById('archiveFlag');
        const accessInput = document.getElementById('accessFlag');
